...
uploader.bind('UploadProgress', function(up, file) {
  if(file.percent < 100){
    ...
    $('#upload_progress_bar').show().css('background-position', file.percent+'% 0%');
    $('#upload_progress_bar #plupload-progress-status').css('width', file.percent+'%');
  }
  else {
    $('#upload_progress_bar #plupload-progress-status').css('width','100%');
  }
});
...
$("form").submit(function(e){
  ...
  if (uploader.files.length > 0) {
    ...
    $('.tcenter.grayField.ral').show(function(){
      $('#pickfiles').hide();
    });
    $('#upload_progress_bar #plupload-progress-status').css('width', '5%');
    ...
    $('.tcenter.grayField.ral').show('fast', function () {
      uploader.start();
      /*$('.plupload.flash object').hide();*/
    });
  };
